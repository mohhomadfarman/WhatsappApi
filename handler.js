...
//       let userMsg = msg_body.replace(/\s+/g, '_').toLowerCase()
//      const dilogs = {
//        test:[{
//        text: `${userName}, Spring is here! 

// Give your wardrobe a makeover with the newly launched Spring Collection in vibrant colors by { {brand_name} }. 

// Explore & place your order today for guaranteed shipping in  ${from}  day!

// Insert <quick reply button> View Catalog

// Insert <quick reply button> Deal of the Day`
//      }],
//               hi:[
//                 {
...
//       console.log(dilogs[userMsg] === undefined, "Name");
//       if(dilogs[userMsg] !== undefined){
//          axios({
...
//     }else if (dilogs[userMsg] === undefined){
